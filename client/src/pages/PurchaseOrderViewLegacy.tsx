    ...
    <div className="max-w-none p-4 bg-white min-h-screen print:p-0 print:m-0">
      ...
      <div className="print:font-mono print:text-sm">
        ...
        <div className="border border-gray-400 bg-gray-100 text-center">
          <div className={`grid gap-0 text-base font-bold py-2 ${hasCRV ? 'grid-cols-13' : hasBillBack ? 'grid-cols-12' : 'grid-cols-11'}`} style={{ gridTemplateColumns: `60px 320px 55px 75px 75px ${hasBillBack ? '75px ' : ''}65px 75px 75px 75px${hasCRV ? ' 60px 75px' : ''} 90px` }}>
        ...
        {purchaseOrder.items?.map((item: PurchaseOrderItem, index: number) => {
          ...
          return (
            <div key={item.id || index} className="border-b border-gray-300">
              <div className={`grid gap-0 text-base py-2 ${hasCRV ? 'grid-cols-13' : hasBillBack ? 'grid-cols-12' : 'grid-cols-11'}`} style={{ gridTemplateColumns: `60px 320px 55px 75px 75px ${hasBillBack ? '75px ' : ''}65px 75px 75px 75px${hasCRV ? ' 60px 75px' : ''} 90px` }}>
